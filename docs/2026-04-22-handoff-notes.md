...
```text
이 문서는 2026-04-22 시점 인수인계 기록이다.
2026-04-23 이후 현재 기본 구현 상태는 README.md와
docs/2026-04-23-implementation-task-log.md를 함께 보는 것이 가장 정확하다.
현재 기본 실행은 runWeeklyLabWorkflow()이며,
이메일 발송은 아직 기본 흐름에 연결하지 않았다.
```
