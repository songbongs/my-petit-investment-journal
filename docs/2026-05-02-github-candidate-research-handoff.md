...
```text
G:\내 드라이브\[ Cloud Notes ]\Obsidian Vault\my-AI-Playground\10_Projects\SSMK-Weekly-Lab
```
...
```text
G:\내 드라이브\[ Cloud Notes ]\Obsidian Vault\my-AI-Playground\10_Projects\SSMK-Weekly-Lab\sources\GitHub 후보 프로젝트 1차 리스트.md
```
